...
def polynomial_regression(degree):
    """Trains data in diabetes_prediction_india.csv for a polynomial regression model"""
    ...
    plt.plot(X_test, y_pred, color='red')
    plt.savefig("age_sugar_correlation.png")
    plt.savefig(os.path.join(BASE_DIR,"REGRESSION",f"polynomial{degree}_age_sugar_correlation.png"))
